...
/**
 * A multi-column testimonial carousel that slides a fixed number of cards
 * at a time. Visible card count is derived from the rendered card width
 * (set via CSS custom properties in the section schema), so it stays
 * correct at any breakpoint without hardcoded widths in JS.
 *
 * @typedef {object} Refs
